...
Feature: Checkout with variant and Non Variant product with Coupon Exclude on Variant Item
  ...
  Scenario:  Exclude on Variant Item and  Applied to Cart With Non Variant Item
    ...
    * def cart = call read('classpath:karate/core/cart/addToCart.feature@AddingMultipleItemToCart') {ItemId1: '#(ItemId)', amount1: '#(priceForItem1)', ItemAttributes1:'#(ItemId1Attributes)', ItemId2: '#(ItemId1)' , amount2: '#(priceForItem2)', ItemAttributes2:'#(ItemAttributes)'}
