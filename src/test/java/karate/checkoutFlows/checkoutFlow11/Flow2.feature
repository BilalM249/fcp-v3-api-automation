@Sanity
Feature: Checkout with variant product Along with CART VALUE AMT Off coupon

  Scenario: CART VALUE  Coupon Applied to Cart with Variant Item
    ...
    * def cart = call read('classpath:karate/core/cart/addToCart.feature@AddingSingleItemToCart') {ItemId: '#(ItemId1)', ItemAttributes:'#(ItemId1Attributes)'}
